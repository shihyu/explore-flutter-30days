...
5.  期望 Provider 狀態，目前的狀態是 AsyncData，內容為 `ThemeMode.light`  
    ![](images/20120687efZ49T0Bt6.png)

最後驗證 Listener 是不是沒有狀態的更新了，而且存取 LocalStorage 的操作只有一次  
![](images/20120687vGuWXwZR9k.png)

測試運行成功！  
![](images/201206873Po7NVGf2x.png)
...
![](images/20120687iqbg6dDM38.png)  
![](images/20120687d5BXjUKKoS.png)

### 實作

通常一開始都是先使用 `when()` 和 `then()` 相關 API，進行操作的資料偽照。接著透過 `listen()` 進行 Provider 狀態的監聽  
![](images/20120687jSSe29CITg.png)
...
3.  最後確認資料只有被存取過一次  
    ![](images/20120687ezxrpy2PJa.png)

測試運行成功  
![](images/20120687an0wpCAfLs.png)
...
![](images/20120687B4xBsLt0JT.png)  
![](images/20120687s1MfObf2jv.png)
